...
The block supports a margin layout for documents wide enough to host it (the "glossary in margin" pattern from the [html-effectiveness examples](https://thariqs.github.io/html-effectiveness/)), and a stacked layout for narrower contexts.
