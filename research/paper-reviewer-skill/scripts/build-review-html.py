...
Patterns borrowed from the separate single-html-document skill, in particular its
page contract: sidebar TOC, no horizontal scroll, print-readable, offline-safe,
all assets inlined.
