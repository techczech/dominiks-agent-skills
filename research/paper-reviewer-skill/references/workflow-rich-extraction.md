...
It wraps the [`academic-pdf-to-mkd`](https://github.com/techczech/academic-pdf-to-mkd)
skill — a separate repo you clone yourself — which
...
```bash
# One-time companion-skill setup
git clone https://github.com/techczech/academic-pdf-to-mkd.git ~/skills/academic-pdf-to-mkd
cd ~/skills/academic-pdf-to-mkd
uv sync                # installs docling, pymupdf4llm, mineru[all] into a venv
brew install poppler ocrmypdf    # for OCR preflight + fallbacks

# Tell this skill where the clone is (add to your shell profile to make it stick).
# Omit it only if you cloned to the default location, ~/skills/academic-pdf-to-mkd.
export ACADEMIC_PDF_SKILL=~/skills/academic-pdf-to-mkd
```
...
- External: [`academic-pdf-to-mkd`](https://github.com/techczech/academic-pdf-to-mkd) — the extraction engine this wrapper drives
