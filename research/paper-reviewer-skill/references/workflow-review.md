...
The skill ships six review styles:
...
5. **Methods and Relevance** - Methods deep dive plus an explicit "Relevance for Today" reading
6. **Claims Audit and Press** - Probity audit of the paper's own claims and of how the press represented them

Each style serves different purposes and contexts. The sections below work
through the first four in detail; see
[templates-guide.md](templates-guide.md) for all six.
