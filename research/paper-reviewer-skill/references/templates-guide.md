...
| [methods-and-relevance.md](#methods-and-relevance) | Methods deep dive + "Relevance for Today" | 2000-3500 words | Older papers still being cited as current evidence |
...
**Template**: [`templates/methods-and-relevance.md`](../templates/methods-and-relevance.md)

### When to Use

Use this template when:

- The paper is old enough that its field has moved, but it is still being cited as current evidence.
- The technology, population, or policy context it studied has changed since publication.
- Someone is about to build on it and you need to say what it still licenses.

### What It Does

Runs the full [methods deep dive](#methods-deep-dive) audit, then adds a
**Relevance for Today** section that separates findings which still hold from
findings whose support has expired, names what the paper is still good for
(often a design or an instrument rather than a result), and ends with one
sentence of guidance on how it should be cited now.

### Key Principle

Keep the two halves apart. Audit the methods on the paper's own terms first,
without reference to what came later; only then ask what has changed. A paper
can be methodologically excellent and no longer applicable, or methodologically
weak and still the only measurement anyone has.
