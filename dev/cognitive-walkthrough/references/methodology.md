...
## The four questions (quoted verbatim from NN/g)
...
## Worked example — health clinic tablet (NN/g's, summarised)

The example below is NN/g's, not this skill's, and is reproduced here only to show the shape of a good verdict. NN/g uses a tablet app for a health clinic to demonstrate. Two tasks:
...
Nielsen Norman Group, "Cognitive Walkthroughs", <https://www.nngroup.com/articles/cognitive-walkthroughs/>. Retrieved 2026-05-22. NN/g is the working reference; the method itself originates with Lewis, Polson, Wharton and Rieman in the late 1980s.

The method is not copyrightable and is reproduced here on purpose. The specific wording of the four questions, the pass/fail rule and the clinic example is NN/g's, quoted and marked as such above. Everything else in this skill — the agent workflow, file conventions, report template — is original.
