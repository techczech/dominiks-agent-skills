...
# A skill description is a trigger, not a summary, so it should not carry
# layout detail: a path separator, or a project folder token such as
# _TASK-LOG or _CHANGELOG, means implementation detail leaked into the trigger.
DESC_DETAIL = re.compile(r"/|\b_[A-Z][A-Z0-9-]+\b")
