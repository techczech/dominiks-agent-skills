...
Complete organization of a host repository that vendors this skill.

> This file describes the *vendored* layout (skill committed into the host repo's
> `skill/` folder, PDFs kept in `source-files/`). See
> [setup-architecture.md](setup-architecture.md) for how it compares with the
> shared-clone layout in [SKILL.md](../SKILL.md), where each paper folder holds its
> own PDF.
...
│
├── .claude/skills/paper-reviewer-skill@ → ../../skill/      # Claude Code discovery
├── .antigravity/skills/paper-reviewer-skill@ → ../../skill/ # Antigravity discovery
├── .gemini/skills/paper-reviewer-skill@ → ../../skill/      # Gemini discovery
├── .codex/skills/paper-reviewer-skill@ → ../../skill/       # Codex discovery
│
...
│   ├── methods-deep-dive.md
│   ├── critical-review.md
│   ├── methods-and-relevance.md
│   ├── claims-audit-and-press.md
│   ├── summary-card.md
