...
The cap comes from a real failure. A content-migration project's worklog grew
single lines of ~20 KB, because each run embedded every parser warning
verbatim — often the same message repeated 100 times. The log became
unreadable with standard tools (`tail`, `less`, `jq`).
...
```json
{"timestamp": "2026-04-17T10:42:05+00:00", "run_id": "20260417T104205Z-export", "action": "export", "status": "completed-with-errors", "duration_s": 42.1, "inputs": ["source-files/legacy-export.sql"], "outputs": ["archive/", "derived/intermediate/20260417T104205Z-export/"], "record_counts": {"records": 12101, "assets": 7576}, "warning_count": 108, "warnings_path": "derived/run-logs/20260417T104205Z-export/warnings.json"}
```
