...
Inspired by the separate `single-html-document` skill and its page contract. The relevant rules this builder honours:
...
- External: the `single-html-document` skill — for single-file HTML deliverables beyond a single review
