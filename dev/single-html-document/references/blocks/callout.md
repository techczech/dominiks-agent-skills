...
- type: callout
  data:
    tone: warning
    title: "Don't fight a release-age gate"
    body: "If the project sets a minimum package age (a common supply-chain defence), `npm install foo@latest` resolving to an older version is the gate working as designed. Check the package before overriding it."
```
