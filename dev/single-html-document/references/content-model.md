...
navTitle: First anchor
title: The first concrete example, before any argument.
layout: image-right
figureId: adoption-screenshot
blocks:
  - type: bullets
    items:
      - Not a vendor claim
      - Not a projection
      - A practitioner describing what they actually shipped
notes: >
  Use this slide as the first concrete anchor. The point is where the claim
  comes from, not how strong it sounds: open with evidence the room can check
  before introducing the argument it supports.
---
```
